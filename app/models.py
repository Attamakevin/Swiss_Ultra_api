...
class User(db.Model):
    ...
    notifications = db.relationship('Notification', backref='user_notifications', overlaps="user_notifications",lazy=True)
...
class Notification(db.Model):
    ...
    user = db.relationship('User', backref='notifications_list',overlaps="notifications_list", lazy=True)  # Backref to user's notification list
